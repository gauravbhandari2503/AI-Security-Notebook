...
1. **NEVER** rely on the model's parametric knowledge for facts about the user's specific domain, codebase, or data, (Treat the model like a very smart intern who knows general tech — but knows nothing about your specific system unless you tell it.) .
